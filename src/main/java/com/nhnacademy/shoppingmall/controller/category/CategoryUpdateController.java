...
public class CategoryUpdateController implements BaseController {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        int targetCategoryId = Integer.parseInt(req.getParameter("category_id"));
        String updateCategoryName = req.getParameter("category_name");
        Category updateCategory = new Category(targetCategoryId, updateCategoryName);
